...
# model settings, CAT and SegDeformer and mask_guide
...
model = dict(
    ...
    decode_head=dict(
        ...
        type='SegFormerHead_clips2_resize_1_8_CAT_SegDeformer_MaskGuided_ensemble4',
        ...
        backbone='b1',
        cross_method = 'CAT',
        seg_mask_use='cluster_Agent' #['cluster_guide','cluster_reduce_cmp','cluster_Agent','mask_guide','top-k_mask']
        ),
