_base_ = [
    ...
    '../../_base_/datasets/vspw_subset_repeat2.py',
...
model = dict(
    ...
    backbone=dict(
        ...
        style='pytorch'),
    decode_head=dict(
        type='SegFormerHead_clips2_resize_1_8_Cluster_SegDeformer_aux_loss_ensemble4', # cluster for t and Segdeformer
