...
def multi_gpu_test(model,
    ...
    for i, data in enumerate(data_loader):
        ...
        # print("file_name",file_name) #data/cityspace/cityspace/leftImg8bit_sequence/val/lindau/lindau_000010_000019_leftImg8bit.png
        pre_file_name = file_name.split('/')[-3]
        # dir_pred = '/root/workspace/XU/Code/VSS-MRCFA-main/results/Cluster_Segdeformer_124_capa_vit/'+pre_file_name  # Cluster_Segdeformer_124_capa_vit_cluster_block2_dw_pw_repair_inner_center_15600
